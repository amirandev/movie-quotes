            ...
            <div class="px-4 pb-4 pt-2">
                ...
                <div class="px-4 pb-4 pt-2 bg-light rounded-3 d-block">
                    <div class="quoteBox">
                        ...
                        <div class="textindentQuote mt-2 fz-15">
                            {{ isLang('ka') ? $row->text_ka : $row->text_en }}
                        </div>
                ...
                <div style="min-height: 40px;"><!--space--></div>

                <div class="fixthebuttonsBottom px-4 pb-4 mt-3 d-flex align-items-center justify-content-between">
