...
@section('content')
    ...
    <section class="p-normal bg-white mt-3 filterAndResults">
        <div class="mt-0 parent-gtu">
            ...
            <div class="text-muted">
                {{ __('main.manage_quotes_mutedText') }}
            </div>
            <div class="pt-3">
    ...
    <section class="filterAndResults">
        <div class="quotes mt-3" id="load_content" data-source="{{ route('admin.quotes.json') }}">
            <!--results here-->
        </div>
        <div class="d-flex align-items-center justify-content-center p-4">
            <div class="btn btn-gtu py-2 hide" id="loadmore">{{ __('main.search') }}</div>
        </div>
    </section>
