@extends('layouts.default', ['pagetitle' => __('main.directors_movies')])
@section('content')
    <div class="text-center py-4 mt-4">
        <h1>{{ __('main.directors_movies') }}</h1>
        <h5 class="text-primary">{{ isLang('ka') ? $director->name_ka : $director->name_en }}</h5>
    </div>
    ...
    <div class="widerContainer">
        ...
        <section class="filterAndResults">
            <div class="movies mt-3" id="load_content" data-source="{{ route('movies.json', ['by' => $director->id]) }}">
                <!--results here-->
            </div>
